...
export default function MessageInput({ value, onChange, onSend } : { value:string; onChange: (v:string)=>void; onSend: ()=>void }){
  ...
  return (
    <div className="mt-4 flex items-center gap-3">
      ...
      <motion.button whileTap={reduce ? {} : { scale: 0.97 }} onClick={handleSend} disabled={sending} className="bg-gradient-to-r from-primary to-accent px-4 py-2 rounded-full shadow hover:scale-105 active:scale-95 transition">
